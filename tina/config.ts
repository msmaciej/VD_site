    ...
    collections: [
      ...
      // ── SITE SETTINGS ─────────────────────────────────────────────────────
      {
        ...
        fields: [
          ...
          { type: "boolean", name: "enableDepthBackground",
          ...
          { type: "number", name: "depthNodeCount", label: "Depth background: number of points",
            description: "Default 90. Higher = denser field, more render cost." },
          { type: "number", name: "depthConnectDistance", label: "Depth background: connection distance",
            description: "Default 5.4. Higher = more lines drawn between points (denser web)." },
          { type: "number", name: "depthLineOpacity", label: "Depth background: line opacity (0–1)",
            description: "Default 0.16. How visible the connecting lines are." },
          { type: "number", name: "depthNodeOpacity", label: "Depth background: point opacity (0–1)",
            description: "Default 0.75. How visible the points themselves are." },
          { type: "string", name: "depthNodeColor", label: "Depth background: point colour override",
            description: "Leave empty to auto-match the theme's text colour.",
            ui: { component: "color" } },
          { type: "string", name: "depthFogColor", label: "Depth background: fog colour override",
            description: "Leave empty to auto-match the theme's background colour.",
            ui: { component: "color" } },

          { type: "boolean", name: "enablePlanetarySystems",
          ...
          { type: "number", name: "planetarySystemCount", label: "Planetary systems: number of systems",
            description: "Default 4." },
          { type: "number", name: "planetaryMaxPlanets", label: "Planetary systems: max planets per system",
            description: "Default 4. Each system gets a random count from 1 up to this, for natural variety." },
          { type: "number", name: "planetaryOrbitMinRadius", label: "Planetary systems: orbit distance, minimum (0–1)",
            description: "Default 0.35. Fraction of the base orbit size — how close the nearest planet can sit to its star." },
          { type: "number", name: "planetaryOrbitMaxRadius", label: "Planetary systems: orbit distance, maximum (0–1)",
            description: "Default 1. How far the outermost planet can sit from its star." },
          { type: "string", name: "planetaryStarColor", label: "Planetary systems: star colour override",
            ...
            ui: { component: "color" } },
          { type: "number", name: "planetaryPathOpacity", label: "Planetary systems: orbit path opacity (0–1)",
