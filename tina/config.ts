...
// Letter-spacing (tracking). One shared list so every field that offers
// tracking — the Typography master switch, the Hero title/subtitle — uses
// the exact same steps, rather than each hardcoding its own.
...
const pageTemplates = [
  {
    ...
    fields: [
      ...
      { type: "string", name: "cardGap", label: "Gap between cards (optional, overrides site default)",
        ...
        fields: [
          ...
          { type: "object", name: "typography", label: "Typography — fonts for every named role (Title, Body, Data page, Fit Check, etc.)",
            ...
            fields: [
              ...
              { type: "object", name: "label", label: "Small labels (eyebrows, tags, section labels)",
              ...
              { type: "object", name: "docTitle", label: "Data page — main heading",
                fields: [
                { type: "string",  name: "font",      label: "Font",      options: fontTypeOptions },
                { type: "string",  name: "size",      label: "Size",      options: fontSizeOptions },
                { type: "string",  name: "weight",    label: "Weight",    options: fontWeightOptions },
              ...
              { type: "object", name: "docLede", label: "Data page — intro paragraph",
                fields: [
                { type: "string",  name: "font",      label: "Font",      options: fontTypeOptions },
                { type: "string",  name: "size",      label: "Size",      options: fontSizeOptions },
                { type: "string",  name: "weight",    label: "Weight",    options: fontWeightOptions },
              ...
              { type: "object", name: "docBody", label: "Data page — body text, lists, notes",
                fields: [
                { type: "string",  name: "font",      label: "Font",      options: fontTypeOptions },
                { type: "string",  name: "size",      label: "Size",      options: fontSizeOptions },
                { type: "string",  name: "weight",    label: "Weight",    options: fontWeightOptions },
              ...
              { type: "object", name: "quizBody", label: "Fit Check — result text & form input",
                fields: [
                { type: "string",  name: "font",      label: "Font",      options: fontTypeOptions },
                { type: "string",  name: "size",      label: "Size",      options: fontSizeOptions },
                { type: "string",  name: "weight",    label: "Weight",    options: fontWeightOptions },
              ...
              { type: "object", name: "button", label: "Buttons (call-to-action links)",
          ...
          { type: "object", name: "layout", label: "Layout dimensions", fields: [
            ...
            { type: "string", name: "cardGridSpacing", label: "Card grid — default space above (from sub-title)",
            ...
            { type: "string", name: "cardGap", label: "Card grid — default gap between cards",
            ...
            { type: "string", name: "cardInternalSpacing", label: "Card grid — default space within each card",
            ...
            { type: "string", name: "ctaShape", label: "Button — default shape",
